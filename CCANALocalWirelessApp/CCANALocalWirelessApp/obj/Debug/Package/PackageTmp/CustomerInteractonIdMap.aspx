...
<body>
    ...
    <div>
        <table>
            ...
            <tr>
                <td colspan="2">
                    <asp:RequiredFieldValidator ID="reqCustomerAccount" ForeColor="Red" ControlToValidate="txtMDN" runat="server" ErrorMessage="MDN is required."></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td colspan="2">
